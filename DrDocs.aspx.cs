...
public partial class DrDocs : System.Web.UI.Page
{
            ...
            if (Qid != "")
            {
                ...
                if (lbldailyreportId.Text != "0")
                {
                    ...
                    if (obj.DailyReport_Select(lbldailyreportId.Text) > 0)
                    {
                        ...
                        General.GridBindwithCommand(gvElevationDrawings, "select * from Daily_Report_Docs where DA_ID= '" + lbldailyreportId.Text + "'");
                    }
                }
            }
        }
