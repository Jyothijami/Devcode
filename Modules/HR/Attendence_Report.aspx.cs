...
public partial class Modules_HR_Attendence_Report : System.Web.UI.Page
{
        ...
        foreach (GridViewRow gvr in gvEmpCTC.Rows)
        {
            if (((CheckBox)gvr.FindControl("CheckBox1")).Checked)
            {
                try
                {
                    ...
                    if (cob.Text == "" || cob.Text == null) { cob.Text = "0"; }
                    if (clc.Text == "" || clc.Text == null) { clc.Text = "0"; }
                    if (cla.Text == "" || cla.Text == null) { cla.Text = "0"; }
                    if (ccb.Text == "" || ccb.Text == null) { ccb.Text = "0"; }
