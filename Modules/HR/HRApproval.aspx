<%@ Page Title="" Language="C#" MasterPageFile="~/NLMain.master" AutoEventWireup="true" CodeFile="HRApproval.aspx.cs" Inherits="Modules_HR_HRApproval" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     ...
     <div class="panel panel-default">
			                <div class="panel-heading"><h6 class="panel-title"><i class="icon-file"></i> HR Leave Approval</h6> </div>
...
select *,EMP_FIRST_NAME+' '+EMP_LAST_NAME as EMPName from Leave_Application,Employee_Master where Leave_Application.Emp_Id = Employee_Master.EMP_ID and HodStatus != 'Open' and Hrstatus = 'Open'"></asp:SqlDataSource>
