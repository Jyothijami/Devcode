<%@ Page Title="" Language="C#" MasterPageFile="~/NLMain.master" AutoEventWireup="true" CodeFile="HODApproval.aspx.cs" Inherits="Modules_HR_HODApproval" %>
...
select *,EMP_FIRST_NAME+' '+EMP_LAST_NAME as EMPName from Leave_Application,Employee_Master where Leave_Application.Emp_Id = Employee_Master.EMP_ID and HodStatus = 'Open'"></asp:SqlDataSource>
