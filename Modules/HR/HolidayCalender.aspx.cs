...
public partial class Modules_HR_HolidayCalender : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            txtDateselTbox.Text = DateTime.Now.ToString("dd/MM/yyyy", CultureInfo.InvariantCulture);
            txtDay.Text = DateTime.Now.ToString("dd/MM/yyyy", CultureInfo.InvariantCulture);
    ...
    private void AddHoliday()
    {
        ...
        TimeSpan diff = Convert.ToDateTime(txtDay.Text) - Convert.ToDateTime(txtDateselTbox.Text);
