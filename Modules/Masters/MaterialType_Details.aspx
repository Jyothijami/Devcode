<%@ Page Title="" Language="C#" MasterPageFile="~/NLMain.master" AutoEventWireup="true" CodeFile="MaterialType_Details.aspx.cs" Inherits="Modules_Masters_MaterialType_Details" %>
     ...
     <script type="text/javascript">
         function hi() {
             ...
             .then(function () {
                 ...
                 window.location = 'MaterialType.aspx';
   ...
   <!-- /page header -->
    ...
    <!-- Breadcrumbs line -->
			<div class="breadcrumb-line">
				<ul class="breadcrumb">
					<li><a href="MaterialType.aspx">Item Group</a></li>
					<li class="active">Item Group Details</li>
				</ul>
