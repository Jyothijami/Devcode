<%@ Page Title="" Language="C#" MasterPageFile="~/NLMain.master" AutoEventWireup="true" CodeFile="StorageTemplate_Details.aspx.cs" Inherits="Modules_Masters_StorageTemplate_Details" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 ...
 <div class="page-header">
    ...
    <div class="breadcrumb-line">
        <ul class="breadcrumb">
            <li><a href="Storage_Template.aspx">Storage Terms & Conditions</a></li>
            <li class="active">Storage Terms & Conditions Details</li>
        </ul>
    </div>
    <!-- /breadcrumbs line -->
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <div class="form-group">
                    <label class="col-sm-2 control-label text-right">Storage Terms & Conditions Name :</label>
                    <div class="col-sm-10">
