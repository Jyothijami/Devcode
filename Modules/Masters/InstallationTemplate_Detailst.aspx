<%@ Page Title="" Language="C#" MasterPageFile="~/NLMain.master" AutoEventWireup="true" CodeFile="InstallationTemplate_Detailst.aspx.cs" Inherits="Modules_Masters_InstallationTemplate_Detailst" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
<div class="page-header">
        <div class="page-title">
            <h3>Installation Terms & Conditions</h3>
        </div>
    </div>
    <!-- /page header -->
    ...
    <div class="breadcrumb-line">
        <ul class="breadcrumb">
            <li><a href="Installation_Template.aspx">Installation Terms & Conditions</a></li>
            <li class="active">Installation Terms & Conditions Details</li>
        </ul>
    </div>
    <!-- /breadcrumbs line -->
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <div class="form-group">
                    <label class="col-sm-2 control-label text-right">Installation Terms & Conditions :</label>
                    <div class="col-sm-10">
