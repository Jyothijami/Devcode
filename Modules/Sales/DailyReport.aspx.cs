...
using phani.Classes;
public partial class Modules_Sales_DailyReport : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            //lblUserType.Text = General.Authentication.GetEmployeeInSession(General.Authentication.Logged_EMP_Details.EmpType);
            //lblEmpIdHidden.Text = General.Authentication.GetEmployeeInSession(General.Authentication.Logged_EMP_Details.EmpId);
            //lblDeptId.Text = General.Authentication.GetEmployeeInSession(General.Authentication.Logged_EMP_Details.DeptId);
            //lblDeptHeadId.Text = General.Authentication.GetEmployeeInSession(General.Authentication.Logged_EMP_Details.DeptId);
            EmployeeMaster_Fill();
            //ddlPreparedBy.SelectedValue = General.Authentication.GetEmployeeInSession(General.Authentication.Logged_EMP_Details.EmpId);
            //ddlCommentedBy.SelectedValue = General.Authentication.GetEmployeeInSession(General.Authentication.Logged_EMP_Details.EmpId);
            BindDailyReportDtls();
            BindGrid_All();
        }
    }
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            if (gvDailyReport.Rows.Count > 0)
            {
                ...
                {
                    objdr.DRDate = General.toMMDDYYYY(gvr.Cells[3].Text);
    ...
    protected void btnSearchGo_Click(object sender, EventArgs e)
    {
        ...
        //else if (ceSearchFrom.Enabled == true) { lblSearchValueFromHidden.Text = General.Classes.General.toMMDDYYYY(txtSearchValueFromDate.Text); }
        //if (ceSearchValueToDate.Enabled == false) { lblSearchValueHidden.Text = txtSearchText.Text; }
        //else if (ceSearchValueToDate.Enabled == true) { lblSearchValueHidden.Text = General.Classes.General.toMMDDYYYY(txtSearchText.Text); }
