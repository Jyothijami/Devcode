<%@ Page Title="" Language="C#" MasterPageFile="~/NLMain.master" AutoEventWireup="true" CodeFile="BomDetails.aspx.cs" Inherits="Modules_Sales_BomDetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="page-header">
        <div class="page-title">
            <h3>Sales Order BOM(Bill of Materials) </h3>
        </div>
    </div>
