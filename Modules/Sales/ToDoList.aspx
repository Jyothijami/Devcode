<%@ Page Title="" Language="C#" MasterPageFile="~/NLMain.master" AutoEventWireup="true" CodeFile="ToDoList.aspx.cs" Inherits="Modules_Sales_ToDoList" %>
                ...
                <div class="panel-body">
                       ...
                       <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                  ...
                                  <asp:SqlDataSource ID="usersds1" runat="server" ConnectionString="<%$ ConnectionStrings:DBCon %>" SelectCommand="SELECT [EMP_ID], [EMP_FIRST_NAME] FROM [Employee_master]  ORDER BY [EMP_ID]"></asp:SqlDataSource>
