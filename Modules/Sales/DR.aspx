<%@ Page Title="" Language="C#" MasterPageFile="~/NLMain.master" AutoEventWireup="true" CodeFile="DR.aspx.cs" Inherits="Modules_SM_DR" %>
                      ...
                      <div runat="server" id="hide" visible="false">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                ...
                                <asp:TextBox ID="txtPurpose" CssClass="editor" placeholder="Enter Purpose"  TextMode="MultiLine"  runat="server"></asp:TextBox>
