...
public partial class Modules_Sales_DyReport : System.Web.UI.Page
{
    System.Data.SqlClient.SqlConnection con = new SqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings["DBcon"].ToString());
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (ddlAttendedBy.SelectedItem.Value != "0")
            {
                ...
                objdr.Purpose = HttpUtility.HtmlEncode(txtPurpose.Text);
