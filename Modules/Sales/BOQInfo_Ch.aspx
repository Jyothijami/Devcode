<%@ Page Title="" Language="C#" MasterPageFile="~/MasterForms/NLMain.master" AutoEventWireup="true" CodeFile="BOQInfo_Ch.aspx.cs" Inherits="Modules_Sales_BOQInfo" %>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-actions text-center">
                        <asp:Button ID="btnDoorSubmit" runat="server" CssClass="btn btn-primary" Text="Save" OnClick="btnDoorSubmit_Click" />
                    </div>
                </div>
            </div>
        </ContentTemplate>
