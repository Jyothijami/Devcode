<%@ Page Title="" Language="C#" MasterPageFile="~/NLMain.master" AutoEventWireup="true" CodeFile="DailyReport.aspx.cs" Inherits="Modules_Sales_DailyReport" %>
                    ...
                    <td colspan="3" style="height: 1px">
                        <table width="100%">
                                    ...
                                    <table style="width: 64px">
                                        <tr>
                                            <td style="width: 100px">
                                                <asp:DropDownList
                                                    ID="ddlHour" runat="server"    TabIndex="3" Width="60px" EnableTheming="False">
                                            ...
                                            <td style="width: 100px">
                                                <asp:DropDownList ID="ddlMin" runat="server"    TabIndex="4" Width="60px" EnableTheming="False">
                                            ...
                                            <td style="width: 100px">
                                                <asp:DropDownList ID="ddlAMPM" runat="server"    TabIndex="5" Width="60px" EnableTheming="False">
                                ...
                                <td>
                                    <table style="width: 64px; height: 32px;">
                                        <tr>
                                            <td style="width: 100px">
                                                <asp:DropDownList
                                                    ID="ddlOutHour" runat="server"    TabIndex="3" Width="60px" EnableTheming="False">
                                                    <asp:ListItem>1</asp:ListItem>
                                                    <asp:ListItem>2</asp:ListItem>
                                                    <asp:ListItem>3</asp:ListItem>
                                                    <asp:ListItem>4</asp:ListItem>
                                            ...
                                            <td style="width: 100px">
                                                <asp:DropDownList ID="ddlOutMin" runat="server"    TabIndex="4" Width="60px" EnableTheming="False">
                                                    <asp:ListItem>00</asp:ListItem>
                                                    <asp:ListItem>05</asp:ListItem>
                                                    <asp:ListItem>10</asp:ListItem>
                                                    <asp:ListItem>15</asp:ListItem>
                                            ...
                                            <td style="width: 100px">
                                                <asp:DropDownList ID="ddlOutAMPM" runat="server"    TabIndex="5" Width="60px" EnableTheming="False">
                                                    <asp:ListItem>AM</asp:ListItem>
                                                    <asp:ListItem>PM</asp:ListItem>
                                                </asp:DropDownList></td>
                                        </tr>
                            ...
                            <tr>
                                ...
                                <td style="text-align: left;">
                                    <asp:TextBox ID="txtClientsName" onkeypress="return check(event)" runat="server"></asp:TextBox></td>
                            </tr>
                            <tr>
                                <td style="text-align: right">
                            ...
                            <tr>
                                ...
                                <td style="text-align: left">
                                    <asp:TextBox ID="txtAddress" runat="server"    TextMode="MultiLine" Width="355px" EnableTheming="False">
                                    </asp:TextBox></td>
                            </tr>
                            <tr>
                                <td style="text-align: right;">
                                ...
                                <td style="text-align: left;">
                                    <asp:TextBox ID="txtPurpose" runat="server"    onkeypress="return check(event)" TextMode="MultiLine" Width="356px" EnableTheming="False"></asp:TextBox></td>
                            </tr>
                            <tr>
                                <td style="text-align: right">
                                    <asp:Label ID="Label4" runat="server"    Text="Remarks"></asp:Label></td>
                                <td style="text-align: left">
                                    <asp:TextBox ID="txtRemarks" runat="server"    onkeypress="return check(event)" TextMode="MultiLine" Width="354px" EnableTheming="False"></asp:TextBox></td>
                            </tr>
                            <tr>
                                <td style="text-align: right">
                        ...
                        <table style="text-align: right;width: 100%" id="tblhide" runat="server" visible="false">
                            <tr>
                                <td style="text-align: left">Go To Page :
                                    ...
                                    <asp:Button ID="btnPageNoSearch" runat="server"   BorderStyle="None" CausesValidation="False" EnableTheming="false"  Text="GO" OnClick="btnPageNoSearch_Click" />
                                </td>
                                <td colspan="4">
                                    ...
                                    <asp:DropDownList ID="ddlSymbols" runat="server"   AutoPostBack="True" 
                                    ...
                                    <asp:TextBox ID="txtSearchValueToDate" runat="server"     EnableTheming="True" Visible="False"
                                        Width="106px">
                                    </asp:TextBox>
                                    ...
                                    <asp:Button ID="btnSearchGo" runat="server"   BorderStyle="None" CausesValidation="False"
                                         EnableTheming="False" Text="Go" OnClick="btnSearchGo_Click" /></td>
                            </tr>
                            <tr>
                                <td colspan="5">
                ...
                <asp:GridView ID="gvDrs" Width="100%" runat="server"   SelectedRowStyle-BackColor="#c0c0c0" EmptyDataText="No Records To Display" AllowPaging="True" OnPageIndexChanging="gvDrs_PageIndexChanging" PageSize="8" AutoGenerateColumns="False" OnRowDataBound="gvDrs_RowDataBound">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="FileName" >
                                                <ItemTemplate>
                                                    <asp:Image runat ="server" EnableTheming="False"  ImageUrl = '<%# Eval("FileName","http://183.82.108.55/DOCUMENTS/SOFiles/{0}") %>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                    </Columns>
                    <HeaderStyle HorizontalAlign="Center" />
