<%@ Page Title="" Language="C#" MasterPageFile="~/NLMain.master" AutoEventWireup="true" CodeFile="SupplierGlassQuatationDetails.aspx.cs" Inherits="Modules_Purchases_SupplierGlassQuatationDetails" %>
    ...
    <div class="page-header">
        <div class="page-title">
            ...
            <div class="breadcrumb-line">
                <ul class="breadcrumb">
                    <li><a href="SupplierGlassQuatation.aspx">Glass Quotations</a></li>
                    <li class="active">Glass Quotations Details</li>
                </ul>
            </div>
            <!-- /breadcrumbs line -->
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h6 class="panel-title">Glass Quotation Details</h6>
                </div>
                <div class="panel-body">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-horizontal">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-2 control-label text-right">Glass Quotation No:</label>
                                    <div class="col-sm-4">
                                        <asp:TextBox ID="txtquatationno" CssClass="form-control" runat="server"></asp:TextBox>
                                    </div>
                                    <label class="col-sm-2 control-label text-right">Glass Quotation Date:</label>
                                    <div class="col-sm-4">
                                    ...
                                    <div class="panel-heading">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-4">
                                                    <asp:TextBox ID="txtsupaddress" CssClass="form-control" runat="server">
                                                    </asp:TextBox>
                                                </div>
                    ...
                    <div class="panel panel-default" runat="server" visible="true" id="panelEnquirydetails">
                        <div class="panel-heading">
                            <h6 class="panel-title">SO Glass Details</h6>
                        </div>
                        <div class="panel-body">
                            <div class="form-horizontal">
                        ...
                        <div class="form-horizontal">
                            ...
                            <div class="form-group">
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <asp:TextBox ID="txtitemamount" CssClass="form-control" runat="server"></asp:TextBox>
                                </div>
