<%@ Page Title="" Language="C#" MasterPageFile="~/NLMain.master" AutoEventWireup="true" CodeFile="SupplierPo_Details.aspx.cs" Inherits="Modules_Purchases_SupplierPo_Details" %>
                ...
                <div class="panel-body">
                    ...
                    <div class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <label class="col-sm-2 control-label text-right">Customer Ref No's:</label>
                            <div class="col-sm-4">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <asp:TextBox ID="txtmessage" Width="100%" Height="200px" CssClass="form-control" runat="server"></asp:TextBox>
                                <cc1:HtmlEditorExtender
                                    ID="HtmlEditorExtender4" TargetControlID="txtmessage" EnableSanitization="false" DisplaySourceTab="false"
                                    runat="server" />
                            </div>
                        </div>
                    </div>
