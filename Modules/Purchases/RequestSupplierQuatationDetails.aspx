<%@ Page Title="" Language="C#" MasterPageFile="~/NLMain.master" AutoEventWireup="true" CodeFile="RequestSupplierQuatationDetails.aspx.cs" Inherits="Modules_Purchases_RequestSupplierQuatationDetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="page-header">
        <div class="page-title">
            <h3>Request Supplier Quotation Details</h3>
        </div>
    </div>
    ...
    <div class="breadcrumb-line">
        <ul class="breadcrumb">
            <li><a href="Supplier_Quotation.aspx">Request Supplier Quotations</a></li>
            <li class="active">Request Supplier Quotations Details</li>
        </ul>
    </div>
    <!-- /breadcrumbs line -->
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-horizontal">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label text-right">Request Quotation No:</label>
                            <div class="col-sm-4">
                                <asp:TextBox ID="txtquatationno" CssClass="form-control" runat="server"></asp:TextBox>
                            </div>
                            <label class="col-sm-2 control-label text-right">Request Quotation Date:</label>
                            <div class="col-sm-4">
            ...
            <div class="panel panel-default" runat="server" visible="true" id="panelEnquirydetails">
                <div class="panel-heading">
                    <h6 class="panel-title">Indent Approved Details</h6>
                </div>
                <div class="panel-body">
                    <div class="form-horizontal">
                    ...
                    <div class="panel-group">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h6 class="panel-title">Indent Approved Details
                                </h6>
                            </div>
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    ...
                                    <asp:BoundField DataField="qtyorder" HeaderText="Qty to Order" />
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="panel-title">
                            Items for Quatations Requested
                        </div>
                    </div>
                    <div class="panel-body">
                        <div class="datatable">
                            ...
                            <div class="row" style="padding-top: 0px">
                                <asp:GridView ID="gvitems" CssClass="table table-striped table-bordered" runat="server" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="Color" HeaderText="Color" />
                                        <asp:BoundField DataField="QtyOrder" HeaderText="Qty" />
                                        <asp:BoundField DataField="ItemcodeId" HeaderText="ItemcodeId" />
                                        <asp:BoundField DataField="ColorId" HeaderText="ColorId" />
                                        <asp:BoundField DataField="SoId" HeaderText="SoId" />
                                        <asp:BoundField DataField ="SoMatId" HeaderText="SoMatId" />
                                        <asp:BoundField DataField="RequestedFor" HeaderText="RequestedFor" />
