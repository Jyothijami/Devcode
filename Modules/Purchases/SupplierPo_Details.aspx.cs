...
public partial class Modules_Purchases_SupplierPo_Details : System.Web.UI.Page
{
    ...
    private void QuatationFill()
    {
        ...
        if (obj.SupPo_Select(Request.QueryString["Cid"].ToString()) > 0)
        {
            ...
            txtmessage.Text = HttpUtility.HtmlDecode(obj.Message);
    ...
    {
        DataRow[] dr = dt.Select("ItemcodeId = '" + gvRow.Cells[9].Text + "' and ColorId = '" + gvRow.Cells[10].Text + "'  ");
        if (dr.Length <= 0)
        {
            dt.Rows.Add();
            ...
            dt.Rows[dt.Rows.Count - 1]["Length"] = gvRow.Cells[5].Text;
            ...
            dt.Rows[dt.Rows.Count - 1]["SoMatId"] = gvRow.Cells[12].Text;
            dt.Rows[dt.Rows.Count - 1]["Requestfor"] = gvRow.Cells[13].Text;
    ...
    private void SetData()
    {
        ...
        if (ViewState["SelectedRecords"] != null)
        {
            ...
            for (int i = 0; i < gvEnqItems.Rows.Count; i++)
            {
                ...
                if (chk != null)
                {
                    DataRow[] dr = dt.Select("ItemCodeId = '" + gvEnqItems.Rows[i].Cells[9].Text + "' and ColorId = '" + gvEnqItems.Rows[i].Cells[10].Text + "'  ");
    ...
    protected void btnAddItems_Click(object sender, EventArgs e)
    {
        ...
        //if (txtrequiredfor.Text == "") { txtrequiredfor.Text = "-"; }
        if (txtlength.Text == "") { txtlength.Text = "0"; }
            ...
            foreach (GridViewRow gvrow in gvitems.Rows)
            {
                if (gvitems.SelectedIndex > -1)
                {
                    if (gvrow.RowIndex == gvitems.SelectedRow.RowIndex)
                    {
                        ...
                        if (txtArea.Text != "0")
                        {
                            dr["Amount"] = (Convert.ToDecimal(txtArea.Text) * Convert.ToDecimal(txtamount.Text)).ToString();
                        }
                        else
                        {
                    ...
                    else
                    {
                        ...
                        dr["Length"] = gvrow.Cells[7].Text;
                        dr["Rate"] = gvrow.Cells[8].Text;
                        dr["Amount"] = gvrow.Cells[9].Text;

                        dr["ItemcodeId"] = gvrow.Cells[10].Text;
                        dr["ColorId"] = gvrow.Cells[11].Text;
                        dr["RequiredDate"] = gvrow.Cells[12].Text;


                        dr["SoId"] = gvrow.Cells[13].Text;
                        dr["SoMatId"] = gvrow.Cells[14].Text;
                        dr["Requestfor"] = gvrow.Cells[15].Text;


                        dr["Area"] = gvrow.Cells[16].Text;
        ...
        if (gvitems.SelectedIndex == -1)
        {
            ...
            if(txtArea.Text != "0")
            {
                drnew["Amount"] = (Convert.ToDecimal(txtArea.Text) * Convert.ToDecimal(txtamount.Text)).ToString();
            }
            else
            {
           ...
           // drnew["Amount"] = txtitemamount.Text;
            ...
            drnew["SoMatId"] = "0";
            //drnew["Requestfor"] = ddlreqfor.SelectedItem.Text;
            if (ddlreqfor.SelectedItem.Text != "NA")
            {
            ...
            {
                drnew["SoId"] = ddlcustrefno.SelectedItem.Value;
                drnew["Requestfor"] = ddlcustrefno.SelectedItem.Text;
            }
    ...
    private void PurQuotationUpdate()
    {
        try
        {
            ...
            objSM.Indentnos = txtindentno.Text;
            ...
            if (objSM.SupPo_Update() == "Data Updated Successfully")
            {
                ...
                foreach (GridViewRow gvrow in gvitems.Rows)
                {
                    ...
                    objSM.SOid = gvrow.Cells[13].Text;
                    objSM.SoMatid = gvrow.Cells[14].Text;
                    objSM.RequiredFor = gvrow.Cells[15].Text;

                    objSM.Area = gvrow.Cells[16].Text;
