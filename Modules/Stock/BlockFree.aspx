<%@ Page Title="" Language="C#" MasterPageFile="~/NLMain.master" AutoEventWireup="true" CodeFile="BlockFree.aspx.cs" Inherits="Modules_Stock_BlockFree" %>
            ...
            <asp:GridView ID="hai" CssClass="table table-bordered" runat="server" AutoGenerateColumns="False">
                <Columns>
                  ...
                  <%--  <asp:BoundField DataField="SalesOrder_No" HeaderText="SO No" SortExpression="SalesOrder_No">
                    ...
                    <asp:TemplateField HeaderText="Indent_Reminder" HeaderStyle-CssClass="text-center">
                         <ItemTemplate>
                            <asp:CheckBox ID="chk" runat ="server" CssClass ="checkbox checkbox-success " />
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
            </asp:GridView>
