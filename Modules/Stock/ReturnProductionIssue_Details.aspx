<%@ Page Title="" Language="C#" MasterPageFile="~/NLMain.master" AutoEventWireup="true" CodeFile="ReturnProductionIssue_Details.aspx.cs" Inherits="Modules_Stock_ReturnProductionIssue_Details" %>
...
<!--
    ...
    <div class="page-header">
        <div class="page-title">
            <h3>Profile Cut Return Details</h3>
        </div>
    </div>
    <!-- /page header -->
    ...
    <div class="breadcrumb-line">
        <ul class="breadcrumb">
            <li><a href="ProductionReturn.aspx">Profile Cut Return</a></li>
            <li class="active">Profile Cut Return Details</li>
        </ul>
    </div>
    <!-- /breadcrumbs line -->
