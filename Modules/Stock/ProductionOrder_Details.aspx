<%@ Page Title="" Language="C#" MasterPageFile="~/NLMain.master" AutoEventWireup="true" CodeFile="ProductionOrder_Details.aspx.cs" Inherits="Modules_Stock_ProductionOrder_Details" %>
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                            <label class="col-sm-2 control-label text-right">SO No :</label>
                            <div class="col-sm-4">
                                <asp:DropDownList ID="ddlSoID" OnSelectedIndexChanged="ddlSoID_SelectedIndexChanged" AutoPostBack="true" CssClass="select-full" Width="100%" runat="server"></asp:DropDownList>
                            </div>

                            <label class="col-sm-2 control-label text-right">Item To Manufacture :</label>
                            <div class="col-sm-4">
                                <asp:DropDownList ID="ddlsodetid"  CssClass="form-control" runat="server"></asp:DropDownList>
                            </div>
                        </div>
