<%@ Page Title="" Language="C#" MasterPageFile="~/NLMain.master" AutoEventWireup="true" CodeFile="IndentApprovalDocs.aspx.cs" Inherits="Modules_Purchases_IndentApprovalDocs" %>
        ...
        <ContentTemplate>
            <div class="page-header">
                <div class="page-title">
                    <h3>Indent Approval Documents</h3>
                </div>
            </div>

            <div class="breadcrumb-line">
                <ul class="breadcrumb">
                    <li><a href="IndentApproval.aspx">Indent Approval Order</a></li>
                    <li class="active">Indent Approval Order Documents</li>
                </ul>
            </div>

            <div class="panel panel-default">
                <div class="panel-heading">
                    <h6 class="panel-title">Indent Approval Order Details</h6>
                </div>
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-5">
                                <label>Indent Approval Order No:  </label>
                            ...
                            <div class="col-md-5">
                                <label>Indent Approval Order Date:  </label>
                        ...
                        <div class="datatable-tasks">
                            ...
                            <asp:GridView ID="gvElevationDrawings" CssClass="table table-bordered" runat="server" AutoGenerateColumns="False">
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="IA_Doc_Id" HeaderText="Sl.No" SortExpression="IA_Doc_Id">
                                        <HeaderStyle Font-Size="Smaller" />
                                    </asp:BoundField>

                                    <asp:BoundField DataField="IA_Doc_Date" HeaderText="Received Date" SortExpression="IA_Doc_Date" DataFormatString="{0:dd/MM/yyyy}">
                                        <HeaderStyle Font-Size="Smaller" />
                                    </asp:BoundField>

                                    <asp:BoundField DataField="IA_Remarks" HeaderText="Remarks" SortExpression="IA_Remarks">
                                        <HeaderStyle Font-Size="Smaller" />
                                    </asp:BoundField>
                                    ...
                                    <asp:TemplateField HeaderText="Documents" HeaderStyle-CssClass="text-center">
                                        <ItemTemplate>
                                            <span class="text-center">
                                                <asp:HyperLink ID="lbtnDocuments" runat="server" CssClass="btn btn-icon btn-success" Target="_blank" NavigateUrl='<%# "~/Content/IndentApprovalDocs/" + Eval("IA_Documents") %>'><i class="icon-attachment"></i></asp:HyperLink>
                                            </span>
                                        </ItemTemplate>
