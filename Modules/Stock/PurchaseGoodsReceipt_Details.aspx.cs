...
public partial class Modules_Stock_GoodsReceipt_Details : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            SCM.SupPo.NewSupPo_Select(ddlPono);
            ...
            if (objSM.PurchaseReceipt_Save() == "Data Saved Successfully")
            {
                ...
                foreach (GridViewRow gvrow in GridView1.Rows)
                {
                   ...
                   if(plantid.SelectedItem.Value != "0")
                    ...
                    objSM.DetPOId = ddlPono.SelectedItem.Value;
                  ...
                  {
                    //  objSM.ScrapStock_Update1(objSM.matid, objSM.rEJECTEDQTY, objSM.plantid, objSM.colorid, objSM.storagelocid, objSM.length);
