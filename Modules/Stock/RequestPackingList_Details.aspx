<%@ Page Title="" Language="C#" MasterPageFile="~/NLMain.master" AutoEventWireup="true" CodeFile="RequestPackingList_Details.aspx.cs" Inherits="Modules_Stock_RequestPackingList_Details" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     ...
     <div class="page-header">
        <div class="page-title">
            <h3>PackingList Issue Details</h3>
        </div>
    </div>
    <!-- /page header -->
    ...
    <div class="breadcrumb-line">
        <ul class="breadcrumb">
            <li><a href="RequestPackingList.aspx">Request PackingList</a></li>
            <li class="active">Request PackingList Details</li>
        </ul>
    </div>
    <!-- /breadcrumbs line -->
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label text-right">Request PackingList No :</label>
                    <div class="col-sm-4">
                        <asp:TextBox ID="txtplno" CssClass="form-control" runat="server"></asp:TextBox>
                    </div>

                    <label class="col-sm-2 control-label text-right">Request PackingList Date :</label>
                    <div class="col-sm-4">
                        <asp:TextBox ID="txtpldate" CssClass="form-control" runat="server"></asp:TextBox>
                        <asp:Image
                        ...
                        <cc1:CalendarExtender Format="dd/MM/yyyy" ID="Calendarextender2" runat="server" PopupButtonID="imgQuotationDate"
                            TargetControlID="txtpldate">
                        </cc1:CalendarExtender>
                    </div>
                </div>

                <div class="form-group">
                    <label class="col-sm-2 control-label text-right">Sales Order :</label>
                    <div class="col-sm-4">
                        <asp:DropDownList ID="ddlso" AutoPostBack="true" OnSelectedIndexChanged="ddlso_SelectedIndexChanged" Width="100%" CssClass="select-full" runat="server"></asp:DropDownList>
                    </div>
                    <label class="col-sm-2 control-label text-right">Project :</label>
                    <div class="col-sm-4">
                        <asp:DropDownList ID="ddlProject" AutoPostBack="true" OnSelectedIndexChanged="ddlProject_SelectedIndexChanged" Width="100%" CssClass="select-full" runat="server"></asp:DropDownList>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <asp:TextBox ID="txtcustaddress" CssClass="form-control" TextMode="MultiLine" runat="server"></asp:TextBox>
                    </div>
                    <label class="col-sm-2 control-label text-right">Delivery Address :</label>
                    <div class="col-sm-4">
                        <asp:TextBox ID="txtdeliveryaddress" CssClass="form-control" TextMode="MultiLine" runat="server"></asp:TextBox>
                    </div>
                </div>

                  <div class="form-group">
                    <label class="col-sm-2 control-label text-right">Method of Dispatch :</label>
                    <div class="col-sm-4">
                        <asp:TextBox ID="txtmethodofdispacth" CssClass="form-control"  runat="server"></asp:TextBox>
                    </div>
                </div>
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label text-right">Total Packets :</label>
                            <div class="col-sm-4">
                                <asp:TextBox ID="txttotalpackets" CssClass="form-control" runat="server"></asp:TextBox>
                            </div>
                             <label class="col-sm-2 control-label text-right">Total Weight :</label>
                            <div class="col-sm-4">
