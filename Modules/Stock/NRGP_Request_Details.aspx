<%@ Page Title="" Language="C#" MasterPageFile="~/NLMain.master" AutoEventWireup="true" CodeFile="NRGP_Request_Details.aspx.cs" Inherits="Modules_Stock_NRGP_Request_Details" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="breadcrumb-line">
        <ul class="breadcrumb">
            <li><a href="NRGP_Request.aspx">NRGP Request</a></li>
            <li class="active">NRGP Request Details</li>
        </ul>
    </div>
    <!-- /breadcrumbs line -->
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label text-right">NRGP Request No :</label>
                    <div class="col-sm-4">
                        <asp:TextBox ID="txtrgpno" CssClass="form-control" runat="server"></asp:TextBox>
                    </div>

                    <label class="col-sm-2 control-label text-right">NRGP Request Date :</label>
                    <div class="col-sm-4">
