<%@ Page Title="" Language="C#" MasterPageFile="~/NLMain.master" AutoEventWireup="true" CodeFile="PurchaseGoodsReceipt_Details.aspx.cs" Inherits="Modules_Stock_GoodsReceipt_Details" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="page-header">
        <div class="page-title">
            <h3>Material Received Notes Details</h3>
        </div>
    </div>
    <!-- /page header -->
    ...
    <div class="breadcrumb-line">
        <ul class="breadcrumb">
            <li><a href="PurchaseGoodsReceipt.aspx">Material Received Notes</a></li>
            <li class="active">Material Received Notes Details</li>
        </ul>
    </div>
    <!-- /breadcrumbs line -->
