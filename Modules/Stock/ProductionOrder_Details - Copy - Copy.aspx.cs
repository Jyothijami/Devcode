...
public partial class Modules_Stock_ProductionOrder_Details : System.Web.UI.Page
{
    ...
    {
        Masters.MaterialMaster.BomMaterialMaster_Select(ddlBomno,ddlItems.SelectedItem.Value);
        Masters.MaterialMaster obj = new Masters.MaterialMaster();
        if (obj.MaterialType_Select(ddlItems.SelectedItem.Value) > 0)
        {

            txtUOM.Text = obj.UomName;
            txtitemDescription.Text = obj.Description;
