<%@ Page Title="" Language="C#" MasterPageFile="~/NLMain.master" AutoEventWireup="true" CodeFile="PackingList_Details.aspx.cs" Inherits="Modules_Stock_PackingList_Details" %>
...
<!--
    ...
    <div class="breadcrumb-line">
        <ul class="breadcrumb">
            <li><a href="Packinglist.aspx">PackingList</a></li>
            <li class="active">PackingList Issue Details</li>
        </ul>
    </div>
    <!-- /breadcrumbs line -->
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label text-right">PackingList No :</label>
                    <div class="col-sm-4">
                        <asp:TextBox ID="txtplno" CssClass="form-control" runat="server"></asp:TextBox>
                    </div>

                    <label class="col-sm-2 control-label text-right">PackingList Date :</label>
                    <div class="col-sm-4">
