<%@ Page Title="" Language="C#" MasterPageFile="~/NLMain.master" AutoEventWireup="true" CodeFile="NRGP_Details.aspx.cs" Inherits="Modules_Stock_NRGP_Details" %>
...
<!--
    ...
    <div class="breadcrumb-line">
        <ul class="breadcrumb">
            <li><a href="NRGP.aspx">NRGP</a></li>
            <li class="active">NRGP Issue Details</li>
        </ul>
    </div>
    <!-- /breadcrumbs line -->
    ...
    <div class="form-horizontal">
        <div class="panel panel-default">
            <div class="panel-body">
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label text-right">Requested NRgp :</label>
                    <div class="col-sm-4">
                        <asp:DropDownList ID="ddlNrequestrgp" AutoPostBack="true" OnSelectedIndexChanged="ddlNrequestrgp_SelectedIndexChanged" Width="100%" CssClass="select-full" runat="server"></asp:DropDownList>
                    </div>
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <asp:DropDownList ID="ddlPreparedBy" CssClass="select-full" Width="100%" runat="server" Enabled="false"></asp:DropDownList>
                            </div>
                        </div>
                    </div>
                </div>
