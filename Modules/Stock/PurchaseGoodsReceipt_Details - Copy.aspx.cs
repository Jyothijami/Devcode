    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (objSM.PurchaseReceipt_Save() == "Data Saved Successfully")
            {
                ...
                foreach (GridViewRow gvrow in GridView1.Rows)
                {
                    objSM.matid = gvrow.Cells[8].Text;
                    ...
                    objSM.colorid = gvrow.Cells[9].Text;

                    objSM.podetid = gvrow.Cells[12].Text;

                    objSM.PurchaseReceiptDetails_Save();

                    objSM.PurchaseOrderDetailsRemainingQty_Update(objSM.podetid, objSM.receivedqty);
                  //  objSM.PurchaseOrderDetailsRecivedQty_Update(objSM.podetid, objSM.receivedqty);

                    objSM.Stock_Update(objSM.matid, objSM.receivedqty, objSM.plantid, objSM.colorid, objSM.storagelocid);
                }
