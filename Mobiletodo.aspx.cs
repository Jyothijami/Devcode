...
public partial class Mobiletodo : System.Web.UI.Page
{
    ...
    private void BindData()
    {
        ...
        using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["DBCon"].ToString()))
        {
            ...
            {
                cmd.CommandText = "SELECT EMP_FIRST_NAME+' '+EMP_LAST_NAME as EMP_FIRST_NAME,EMP_ID FROM EMPLOYEE_MASTER where EMP_ID != 0";
                con.Open();
